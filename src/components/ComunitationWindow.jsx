...
const MessagesWindow = (props) => {
  ...
  return (
    ...
    <h1 className="text-red-600">Předchozí zájemce ztratil zájem o knihu.</h1>
    }

      {showConversation &&
        (ownerEmail === userEmail || takerEmail === userEmail) &&
        taker && (
          <div className="mt-6">
            Komunikace s prodejcem
            <br /> 
            {book.shoppingState !== 3 &&
            <button className="bg-agRed hover:bg-agRed/60 text-white font-bold py-2 px-4 rounded" onClick={handleLostInterest}>Ztratit zájem o knihu</button>
            }
            <ul>
              <li
                className={
